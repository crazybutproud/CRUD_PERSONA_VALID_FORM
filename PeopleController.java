...
public class PeopleController {
    ...
    @PostMapping()
    public String create(@ModelAttribute @Valid Persona persona, BindingResult bindingResult) { //принимает данные и отправляет в базу данных(внедряется объект с ошибками)
